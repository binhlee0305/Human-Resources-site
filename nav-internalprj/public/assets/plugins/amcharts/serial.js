    ...
    e.AmSerialChart = e.Class({
            ...
            if (!this.wheelBusy) {
                ...
                if (l)
                    if (l.mouseIsOver()) {
                        ...
                        0 > a ?
                            d ?
                            ((l = this.endTime - this.startTime), (d = this.startTime + e * g), (g = this.endTime + f * g), 0 < f && 0 < e && g >= c && ((g = c), (d = c - l)), this.zoomToDates(new Date(d), new Date(g))) :
                            (0 < f && 0 < e && this.end >= l - 1 && (e = f = 0), (d = this.start + e), (g = this.end + f), this.zoomToIndexes(d, g)) :
                            d ?
                            ((l = this.endTime - this.startTime), (d = this.startTime - e * g), (g = this.endTime - f * g), 0 < f && 0 < e && d <= k && ((d = k), (g = k + l)), this.zoomToDates(new Date(d), new Date(g))) :
            ...
            for (l = 0; l < b; l++) {
                ...
                if ("100%" == k || "regular" == k)
                    for (e = !1, f = 0; f < c; f++)
                        ...
                        d.valueAxis == g &&
                        "column" == d.type &&
                        (!e && d.stackable && (a++, (e = !0)), ((!d.stackable && d.clustered) || (d.newStack && 0 !== m)) && a++, (d.columnIndex = a - 1), d.clustered || (d.columnIndex = 0), m++);
                if ("none" == k || "3d" == k) {
                    m = !1;
                    for (f = 0; f < c; f++)
            ...
            if (a) {
                ...
                b &&
                    ((b.balloonTextFunction = a.categoryBalloonFunction),
                        ...
                        a.categoryBalloonEnabled && ((f = b.balloon) || (f = {}), (f = e.extend(f, this.balloon, !0)), (f.fillColor = d), (f.balloonColor = d), (f.fillAlpha = c), (f.borderColor = d), (f.color = g), (b.balloon = f)),
        ...
        handleCursorZoomReal: function(a, b, c, d, e) {
            var h = e.target,
                ...
                l;
            this.rotate ?
                (isNaN(a) || isNaN(b) || (this.relativeZoomValueAxes(this.valueAxes, a, b) && this.updateAfterValueZoom()), h.vZoomEnabled && ((f = e.start), (l = e.end))) :
                (isNaN(c) || isNaN(d) || (this.relativeZoomValueAxes(this.valueAxes, c, d) && this.updateAfterValueZoom()), h.hZoomEnabled && ((f = e.start), (l = e.end)));
                            ...
                            for (h = 0; h < d.length; h++) {
                                ...
                                k && f != k ?
                                    ...
                                    ((f.balloon.showBullet = b.bulletsEnabled),
                                        ...
                                        a.hideBalloons || (f.showGraphBalloon(l, b.pointer, !1, b.graphBulletSize, b.graphBulletAlpha), f.balloon.set && m.push({ balloon: f.balloon, y: f.balloon.pointToY }))) :
            ...
            !isNaN(t) && (0 < Math.abs(h) || 0 < Math.abs(f)) ?
                ((l = [B]),
                    ...
                    ((k = "M0,0 L" + d + "," + (g / 2 - (g / 2) * t)),
                        ...
                        0 < d && (m = " A"),
                        e.VML ?
                        ((k += m + Math.round(d - I) + "," + Math.round(g / 2 - J) + "," + Math.round(d + I) + "," + Math.round(g / 2 + J) + "," + d + ",0," + d + "," + g),
                            (k = k + (" L0," + g) + (m + Math.round(-G) + "," + Math.round(g / 2 - H) + "," + Math.round(G) + "," + Math.round(g / 2 + H) + ",0," + g + ",0,0"))) :
                        ((k += "A" + I + "," + J + ",0,0,0," + d + "," + (g - (g / 2) * (1 - t)) + "L0," + g), (k += "A" + G + "," + H + ",0,0,1,0,0")),
                        (G = 90)) :
                    ((m = d / 2 - (d / 2) * t),
                        (k = "M0,0 L" + m + "," + g),
                        e.VML ?
                        ((k = "M0,0 L" + m + "," + g),
                            ...
                            (k += " L" + d + ",0"),
                            (k += m + Math.round(d / 2 + G) + "," + Math.round(H) + "," + Math.round(d / 2 - G) + "," + Math.round(-H) + "," + d + ",0,0,0")) :
                        ((k += "A" + I + "," + J + ",0,0,0," + (d - (d / 2) * (1 - t)) + "," + g + "L" + d + ",0"), (k += "A" + G + "," + H + ",0,0,1,0,0")),
                        (G = 180)),
                    (b = b.path(k).attr(l)),
            ...
            if (e.ifArray(a)) {
                ...
                for (b = k = 0; b < this.data.length; b++)
                    if ((t = this.data[b]))
                        ...
                        ((m = t.time), (d = this.cellWidth), "MM" == this.minPeriod && ((d = 864e5 * e.daysInMonth(new Date(m)) * this.stepWidth), (t.cellWidth = d)), (m = Math.round((m - this.startTime) * this.stepWidth + d / 2))) :
                    ...
                    if (
                        ((k = this.guides[b]),
                            ...
                            ((q = c.getCategoryIndexByValue(k.toCategory)),
                                isNaN(q) || ((d = this.getCoordinate(q - h)), k.expand && (d += this.cellWidth / 2), (p = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, k)), this.pushAxisItem(p, m))),
                            k.category &&
                            ((q = c.getCategoryIndexByValue(k.category)),
                                isNaN(q) || ((r = this.getCoordinate(q - h)), k.expand && (r -= this.cellWidth / 2), (q = (d - r) / 2), (p = new this.axisItemRenderer(this, r, k.label, !0, NaN, q, k)), this.pushAxisItem(p, m))),
                            (w = c.dataDateFormat),
                            k.toDate &&
        ...
        formatBalloonText: function(a, b, c) {
            ...
            if (f)
                if (this.parseDates)
                    ...
                    (g = e.formatDate(b, c, h)), -1 != d.indexOf("fff") && ((d = e.formatMilliseconds(d, f.category)), (g = e.formatMilliseconds(g, b)));
                else {
                    var l;
            ...
            if (this.stickBalloonToCategory) {
                ...
                if (d) {
                    ...
                    this.rotate ?
                        ...
                        ("top" == this.position ? (f && (h -= d.height), 0 < h && (h = 0)) : 0 > h && (h = 0), d.fullWidth && (a += 1), d.fixVLine(a, h));
                }
            }
