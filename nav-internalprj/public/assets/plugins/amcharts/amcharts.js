...
(function () {
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        dispatchScrollbarEvent: function () {
            if (this.skipEvent) this.skipEvent = !1;
                ...
                if (this.percentStart != this.prevPercentStart || this.percentEnd != this.prevPercentEnd || this.prevMultiplier != g)
                    this.fire(a), (this.prevPercentStart = this.percentStart), (this.prevPercentEnd = this.percentEnd), (this.prevMultiplier = g);
            }
        },
        updateDragIconPositions: function () {
            ...
            this.rotate
                ? ((f = this.dragIconWidth), (h = this.dragIconHeight), d.translate((k - h) / 2, c - f / 2), g.translate((k - h) / 2, c + a.height - f / 2))
                : ((f = this.dragIconHeight), (h = this.dragIconWidth), d.translate(b - h / 2, (k - f) / 2), g.translate(b - h / 2 + a.width, (k - f) / 2));
        },
            ...
            if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this);
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (
                        ...
                        k > b && (k = b),
                        0 < g && b - k < g && ((b = Math.round(k + (b - k) / 2)), (m = Math.round(g / 2)), (k = b - m), (b += m), (m = !0)),
                    ...
                    if (g != this.start || this.end != b)
                        k.startOnAxis && (this.resizingRight && g == b && b++, this.resizingLeft && g == b && (0 < g ? g-- : (b = 1))),
                            (this.start = g),
